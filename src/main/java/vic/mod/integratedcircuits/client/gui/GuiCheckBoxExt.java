...
public class GuiCheckBoxExt extends GuiCheckBox implements IHoverable
{
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY) 
	{
		if(visible) 
		{
			field_146123_n = mouseX >= xPosition && mouseY >= yPosition && mouseX < xPosition + boxWidth && mouseY < yPosition + height;
			GuiUtils.drawContinuousTexturedBox(buttonTextures, xPosition, yPosition, 0, 46, boxWidth, height, 200, 20, 2, 3, 2, 2, zLevel);
			...
			if(isChecked()) this.drawCenteredString(mc.fontRenderer, "x", xPosition + boxWidth / 2 + 1, yPosition + 1, 0xE0E0E0);

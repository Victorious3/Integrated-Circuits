...
public class GuiStateLabel extends GuiButtonExt implements IHoverable
{
	...
	public GuiStateLabel(IHoverableHandler parent, int id, int xPos, int yPos, int width, int height, ResourceLocation loc) 
	{
		super(id, xPos, yPos, "");
		this.width = width;
		this.height = height;
	...
	{
		if(!this.visible || states == null || state >= states.length) return;

...
public class Resources 
{
	...
	//Resources
	public static final ResourceLocation RESOURCE_ASSEMBLER_BOTTOM 	= new ResourceLocation(Constants.MOD_ID, "textures/blocks/assembler_bottom.png");
	public static final ResourceLocation RESOURCE_ASSEMBLER_SAFETY 	= new ResourceLocation(Constants.MOD_ID, "textures/blocks/assembler_safety.png");
	
	public static final ResourceLocation RESOURCE_GUI_ASSEMBLER_BACKGROUND 	= new ResourceLocation(Constants.MOD_ID, "textures/gui/assembler.png");
	public static final ResourceLocation RESOURCE_GUI_CONTROLS 				= new ResourceLocation(Constants.MOD_ID, "textures/gui/controls.png");
	public static final ResourceLocation RESOURCE_GUI_CAD_BACKGROUND 		= new ResourceLocation(Constants.MOD_ID, "textures/gui/cad.png");
	public static final ResourceLocation RESOURCE_GUI_7SEGMENT_BACKGROUND	= new ResourceLocation(Constants.MOD_ID, "textures/gui/7segment.png");
	
	public static final ResourceLocation RESOURCE_PCB 			= new ResourceLocation(Constants.MOD_ID, "textures/gui/sublogicpart.png");
	public static final ResourceLocation RESOURCE_PCB_PERF1 	= new ResourceLocation(Constants.MOD_ID, "textures/gui/bg1.png");
	public static final ResourceLocation RESOURCE_PCB_PERF2 	= new ResourceLocation(Constants.MOD_ID, "textures/gui/bg2.png");
	
	public static final ResourceLocation RESOURCE_MISC_CROWN 	= new ResourceLocation(Constants.MOD_ID, "textures/crown.png");
	public static final ResourceLocation RESOURCE_MISC_HALO 	= new ResourceLocation(Constants.MOD_ID, "textures/halo.png");

...
public class IntegratedCircuitsGuiConfig extends GuiConfig {
	...
	public IntegratedCircuitsGuiConfig(GuiScreen parent) {
		super(parent, getConfigElements(), Constants.MOD_ID, false, false, getAbridgedConfigPath(Config.config
			.toString()));
		titleLine2 = "Configure IntegratedCircuits here"; // TODO add
															// localization here
															// if possible
	}
	...
	public static List<IConfigElement> getConfigElements() {
		...
		ConfigElement generalCategoryElement = new ConfigElement(
				Config.config.getCategory(Configuration.CATEGORY_GENERAL));

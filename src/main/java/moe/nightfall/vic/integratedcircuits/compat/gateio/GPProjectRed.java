...
public class GPProjectRed extends GateIOProvider implements IBundledTile {
	...
	public boolean canConnectBundled(int side) {
		...
		// Dirty hack for P:R, will only return true if something can connect
		// from that side
		// As there is no way to get the caller of this method, this will return
		// true even
		// if the part connecting can't connect when a different part on the
		// given side can.
